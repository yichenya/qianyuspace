...
# 使用服务文件连接或DSN字符串
dsn = "host=localhost dbname=postgres user=yang123 password=yang123 port=5432 client_encoding=UTF8"
...
try:
    ...
    dsn2 = "host=localhost dbname=qianyu user=yang123 password=yang123 port=5432 client_encoding=UTF8"
